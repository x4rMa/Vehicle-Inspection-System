				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title" class="padding-top-15 padding-bottom-15">
							<div class="row">
								<div class="col-sm-9">
									<h1 class="mainTitle">EAAS - Japan : page not found </h1>
						...
						<p class="text-small margin-bottom-20">
								...
								<div class="alert alert-danger">The page you requested was not found on the server. <a href="{{ url('/') }}">Go back to Dashboard</a></div>
